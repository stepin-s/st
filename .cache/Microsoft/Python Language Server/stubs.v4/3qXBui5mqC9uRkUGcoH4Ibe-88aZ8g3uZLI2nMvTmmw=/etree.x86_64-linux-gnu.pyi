...
class _MemDebug(_mod___builtin__.object):
...
class AncestorsIterator(_ElementMatchIterator):
    ...
    __pyx_vtable__ = _mod___builtin__.PyCapsule()
    @classmethod
    def __subclasshook__(cls, subclass):
        'Abstract classes can override this to customize issubclass().\n\nThis is invoked early on by abc.ABCMeta.__subclasscheck__().\nIt should return True, False or NotImplemented.  If it returns\nNotImplemented, the normal algorithm is used.  Otherwise, it\noverrides the normal algorithm (and the outcome is cached).\n'
        return False
...
class C14NWriterTarget(_mod___builtin__.object):
...
class CDATA(_mod___builtin__.object):
...
class DocInfo(_mod___builtin__.object):
...
class ETCompatXMLParser(XMLParser):
    ...
    def setElementClassLookup(self):
...
class ElementClassLookup(_mod___builtin__.object):
...
class ElementDepthFirstIterator(_mod___builtin__.object):
...
class ElementTextIterator(_mod___builtin__.object):
...
class ErrorDomains(_mod___builtin__.object):
    ...
    _names = _mod___builtin__.dict()

class ErrorLevels(_mod___builtin__.object):
...
class ErrorTypes(_mod___builtin__.object):
    'Libxml2 error types'
    BUF_OVERFLOW = 7000
...
LIBXML_COMPILED_VERSION = _mod___builtin__.tuple()
LIBXML_VERSION = _mod___builtin__.tuple()
LIBXSLT_COMPILED_VERSION = _mod___builtin__.tuple()
LIBXSLT_VERSION = _mod___builtin__.tuple()
LXML_VERSION = _mod___builtin__.tuple()
...
class LxmlSyntaxError(LxmlError,_mod_exceptions.SyntaxError):
...
class ParseError(LxmlSyntaxError):
    ...
    position = _mod___builtin__.property()
...
class QName(_mod___builtin__.object):
...
class RelaxNGErrorTypes(_mod___builtin__.object):
...
class Resolver(_mod___builtin__.object):
...
def SubElement(_parent, _tag, attrib=None, nsmap=None, **_extra):
...
class XInclude(_mod___builtin__.object):
...
def XPathEvaluator(etree_or_element, namespaces=None, extensions=None, regexp=True, smart_strings=True):
...
class XSLT(_mod___builtin__.object):
...
class XSLTAccessControl(_mod___builtin__.object):
...
class XSLTExtension(_mod___builtin__.object):
    ...
    def apply_templates(self, context, node, output_parent=None, elements_only=False, remove_blank_text=False):
    ...
    def process_children(self, context, output_parent=None, elements_only=False, remove_blank_text=False):
...
class _Attrib(_mod___builtin__.object):
...
class _BaseErrorLog(_mod___builtin__.object):
...
class _Document(_mod___builtin__.object):
...
class _Element(_mod___builtin__.object):
...
class _ElementMatchIterator(_mod___builtin__.object):
...
class _ElementStringResult(_mod___builtin__.str):
...
class _ElementTagMatcher(_mod___builtin__.object):
    '\n    Dead but public. :)\n    '
...
class _ElementTree(_mod___builtin__.object):
    ...
    def getiterator(self, *tags, tag=None):
...
class _ElementUnicodeResult(_mod___builtin__.unicode):
...
class _IDDict(_mod___builtin__.object):
...
class _LogEntry(_mod___builtin__.object):
...
class _SaxParserTarget(_mod___builtin__.object):
...
class _TargetParserResult(_mod_exceptions.Exception):
...
class _Validator(_mod___builtin__.object):
...
class _XPathEvaluatorBase(_mod___builtin__.object):
...
__all__ = _mod___builtin__.list()
__builtins__ = {}
__doc__ = '\nThe ``lxml.etree`` module implements the extended ElementTree API for XML.\n'
__docformat__ = u'restructuredtext en'
__file__ = '/usr/lib/python2.7/dist-packages/lxml/etree.x86_64-linux-gnu.so'
__name__ = 'lxml.etree'
__package__ = None
__pyx_capi__ = _mod___builtin__.dict()
__test__ = _mod___builtin__.dict()
__version__ = u'4.5.0'
def adopt_external_document(capsule, parser=None):
...
class iterparse(_mod___builtin__.object):
...
class iterwalk(_mod___builtin__.object):
...
class xmlfile(_mod___builtin__.object):
